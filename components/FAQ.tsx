...
const faqs: FAQItem[] = [
    ...
    },
    {
        ...
        answer: "JsonExport handles files up to 100MB (tested with ~100,000 rows). Files under 50MB process in seconds. For files over 100MB, we recommend Python with Pandas - see our guide for instructions."
    },
    {
