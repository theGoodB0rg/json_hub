...
export const metadata: Metadata = buildPageMetadata({
    title: 'JSON to CSV Converter Online — Free, Private, No Upload | JsonExport',
    description: 'Convert JSON to CSV instantly — free, private, no upload. Handles nested arrays, large files, and complex data structures. Works offline in your browser.',
            ...
            <ConverterApp
                heading={
                    <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight text-foreground animate-in fade-in slide-in-from-bottom-5 duration-700">
                        ...
                        <span className="text-3xl md:text-5xl text-muted-foreground">Online — Free &amp; Private.</span>
                    </h1>
                }
