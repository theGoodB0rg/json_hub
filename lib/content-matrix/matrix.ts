...
export const conversionMatrix: ContentMatrixItem[] = [
    {
        ...
        targetFormat: 'json',
        platformName: 'CSV',
        title: 'CSV to JSON Converter Online — Free, Instant & 100% Private',
    ...
    },
    {
        ...
        targetFormat: 'excel',
        platformName: 'XML',
        title: 'XML to Excel Converter (XLSX) — Flatten XML Trees to Spreadsheet',
    ...
    },
    {
        ...
        targetFormat: 'json',
        platformName: 'XML',
        title: 'XML to JSON Converter Online — Fast, Accurate & 100% Client-Side',
    ...
    },
    {
        ...
        targetFormat: 'excel',
        platformName: 'CSV',
        title: 'CSV to Excel Converter (XLSX) — Fix Corrupted CSV Formatting',
    ...
    },
    {
        ...
        targetFormat: 'json',
        platformName: 'Jira',
        title: 'Jira CSV to JSON Converter — Flatten Multi-Value Fields & Sprints',
